...
<LinkCard
  title="Add a tool to my server (Claude Code prompt)"
  description="Copy-paste prompt that walks Claude through the canonical pattern with all middleware wiring."
  href="/prompts/add-tool/"
/>
