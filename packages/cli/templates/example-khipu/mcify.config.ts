...
// The Khipu merchant API key authenticates *your server* against Khipu.
// Get one at https://khipu.com/merchant/profile/api → "Crear nueva API Key".
...
export default defineConfig({
  ...
  // The MCP-side auth: agents calling this server present a bearer token
  // matching MCIFY_AUTH_TOKEN. Use a long random string in production:
  //   `openssl rand -hex 32`
